...
function promptTypeToString(promptType) {
  switch (promptType) {
    case _types.MSALPromptType.SELECT_ACCOUNT:
      return 'select_account';

    case _types.MSALPromptType.LOGIN:
      return 'login';

    case _types.MSALPromptType.CONSENT:
      return 'consent';

    case _types.MSALPromptType.WHEN_REQUIRED:
      return 'none';
  }
}
...
class PublicClientApplication {
  ...
  async init() {
    this._pca = new _msalBrowser.PublicClientApplication(this.config);
  }
  /**
